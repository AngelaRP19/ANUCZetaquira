...
public class Gestor {
    ...
    public void agregarProyecto(String nombre, String descripcion, Date fechaInicio, String estado) {
        if (!validarProyecto(nombre)) {
    ...
    private boolean validarProyecto(String nombre) {
        for (Proyecto p : proyectos) {
    ...
    public void registrarActividad(String nombreProyecto, String nombre, String descripcion, TipoActividad tipo, Date fecha) {
        Proyecto proyecto = buscarProyectoPorNombre(nombreProyecto);
        if (!validarProyectoYActividad(proyecto, nombre, tipo, fecha)) return;
    ...
    public void eliminarActividad(String nombreProyecto, String nombre) {
        Proyecto proyecto = buscarProyectoPorNombre(nombreProyecto);
        if (!validarProyectoYNombre(proyecto, nombre)) return;
    ...
    public void actualizarActividadCampo(String nombreProyecto, String nombreActividad, String campo, Object nuevoValor) {
        Proyecto proyecto = buscarProyectoPorNombre(nombreProyecto);
